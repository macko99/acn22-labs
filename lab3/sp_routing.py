...
class SPRouter(app_manager.RyuApp):
    ...
    def route(self, ev, src_ip, dst_ip, printyes):
        msg = ev.msg
    ...
    def _packet_in_handler(self, ev):
        ...
        if eth.ethertype == ether_types.ETH_TYPE_IP:
            #print(eth.ethertype, dpid, self.ip_to_port[dpid])
            ...
            self.route(ev, src_ip, dst_ip, 1)

        if eth.ethertype == ether_types.ETH_TYPE_ARP:
            #print(eth.ethertype, self.ip_to_port[dpid])
